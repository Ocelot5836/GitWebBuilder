...
public class PasteBinCompleteDialog extends Dialog {
    ...
    public void init(@Nullable NBTTagCompound nbtTagCompound) {
        ...
        /*
         * openLinkButton = new Button(getWidth() - 145, getHeight() - 20, "Open"); openLinkButton.setClickListener((mouseX, mouseY, mouseButton) -> { if(mouseButton == 0){ GuiConfirmOpenLink gui = new GuiConfirmOpenLink((res, id) ->{
         * 
         * 
         * 
         * }, messageText, 0, false); gui.disableSecurityWarning(); Minecraft.getMinecraft().displayGuiScreen(gui); } }); this.addComponent(openLinkButton);
         */
        ...
        copyToClipboard.setClickListener((mouseX, mouseY, mouseButton) -> {
            if (mouseButton == 0) {
                ...
                MrCrayfishDeviceMod.proxy.showNotification(new Notification(Icons.COPY, TextFormatting.BOLD + "Copied", "Link To Clipboard").toTag());
            }
        });
